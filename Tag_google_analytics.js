...
tagAnalyticsCNIL.CookieConsent = function() {
	...
	function askDNTConfirmation() {
		var r = confirm("La fonctionnalité DoNotTrack de votre navigateur est activée, confirmez-vous activer la fonction DoNotTrack ?")
		return r;
	}
	...
	//La fonction qui informe et demande le consentement. Il s'agit d'un div qui apparaît au centre de la page
	...
	// Cette fonction en test permet de faire une call GA afin de compter le nombre de visite sans faire de suivi des utilisateurs (fonction en cours de test)
	...
	return {
		...
		start: function() {
			...
			if (!consentCookie) {//L'utilisateur n'a pas encore de cookie, on affiche la bannière et s'il clique sur un autre élément que la bannière, on enregistre le consentement
